...
const TypewriterEffect = ({ text, onComplete }) => {
 ...
 useEffect(() => {
   if (currentIndex < text.length) {
     ...
     }, 8); // Changed from 50ms to 20ms for faster typing
  ...
  return (
    ...
    >
      <motion.div
        ...
        exit={{ y: 50, opacity: 0 }}
        className="bg-gray-900 rounded-lg w-full max-w-2xl m-4 overflow-hidden"
              ...
              >
                ...
                <div className="bg-gray-800 p-4 rounded">
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {project.tech_stack.split(', ').map((tech: string | number | bigint | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<React.AwaitedReactNode> | null | undefined, index: React.Key | null | undefined) => (
                ...
                {project.features && (
                  <div className="bg-gray-800 p-4 rounded">
                    ...
                    <ul className="list-disc list-inside mt-2">
                      {project.features.map((feature: string | number | bigint | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<React.AwaitedReactNode> | null | undefined, index: React.Key | null | undefined) => (
  ...
  return (
      ...
      >
        ...
        <div className="w-full max-w-6xl">
          ...
          {/* Terminal Content */}
          <div className="bg-gray-900 p-12 space-y-8 rounded-b-lg border border-gray-700 shadow-2xl font-mono min-h-[600px] w-full">
            <div className="text-yellow-500">Welcome to 이규빈 Portfolio v1.0.0</div>
            <div className="whitespace-pre-wrap text-green-400 text-base mb-8">{typedText}</div>
            ...
            <AnimatePresence>
              {showResult && (
                  <motion.div
                      ...
                      className="bg-gray-800 p-6 rounded-lg border border-gray-700 mt-12"
                  >
      ...
      <div className="bg-black">
        ...
        <div className="min-h-screen bg-black p-8">
          <div className="max-w-6xl mx-auto">
            <div className="bg-black rounded-3xl shadow-xl overflow-hidden p-8 border border-gray-800">
              <div className="grid grid-cols-12 gap-8">
                ...
                <div className="col-span-4 space-y-6">
                  <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800">
                    <div className="flex flex-col items-center">
                      ...
                      <div className="mt-4 space-y-2 w-full">
                        ...
                        <p className="text-sm text-gray-400 flex items-center gap-2">
                          <GitBranch size={14}/> github.com/sdhg12
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  {awards.map((award, index) => (
                     <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800" key={index}>
                ...
                <div className="col-span-8 space-y-8">
                  <div>
                    <div className="flex mb-6">
                      <h1 className="text-3xl font-bold text-white">Backend Developer</h1>
                    </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="relative">
                      {/* Timeline line */}
                      <div className="absolute h-full w-0.5 bg-gray-800 left-16 top-0"/>
                          ...
                          {[...projects]
                              ...
                              .map(project => (
                                  <motion.div
                                      ...
                                      className={`border-l-2 ${project.type === 'school' ? 'border-green-500' : 'border-blue-500'} pl-4 cursor-pointer p-4 rounded-lg bg-gray-900 grid grid-cols-12 gap-4`}
